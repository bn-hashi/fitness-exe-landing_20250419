        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pt-10 z-10">
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center mb-2">
              <Image src="/images/dumbbell-icon.png" alt="ダンベルアイコン" width={60} height={40} />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-80">
                <Image src="/images/trainer-male.jpg" alt="男性トレーナー" fill className="object-cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-80">
                <Image src="/images/trainer-female.jpg" alt="女性トレーナー" fill className="object-cover" />
              </div>
              <div className="p-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <div className="grid grid-cols-2">
                <div className="relative h-64">
                  <Image src="/images/before-1.jpg" alt="ビフォー" fill className="object-cover" />
                  <div className="absolute top-2 left-2 bg-gray-800 text-white text-xs py-1 px-2 rounded">Before</div>
                </div>
                <div className="relative h-64">
                  <Image src="/images/after-1.jpg" alt="アフター" fill className="object-cover" />
            ...
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <div className="grid grid-cols-2">
                <div className="relative h-64">
                  <Image src="/images/before-2.jpg" alt="ビフォー" fill className="object-cover" />
                  <div className="absolute top-2 left-2 bg-gray-800 text-white text-xs py-1 px-2 rounded">Before</div>
                </div>
                <div className="relative h-64">
                  <Image src="/images/after-2.jpg" alt="アフター" fill className="object-cover" />
                  <div className="absolute top-2 left-2 bg-amber-600 text-white text-xs py-1 px-2 rounded">After</div>
                </div>
              </div>
              <div className="p-4">
            ...
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <div className="grid grid-cols-2">
                <div className="relative h-64">
                  <Image src="/images/before-3.jpg" alt="ビフォー" fill className="object-cover" />
                  <div className="absolute top-2 left-2 bg-gray-800 text-white text-xs py-1 px-2 rounded">Before</div>
                </div>
                <div className="relative h-64">
                  <Image src="/images/after-3.jpg" alt="アフター" fill className="object-cover" />
                  <div className="absolute top-2 left-2 bg-amber-600 text-white text-xs py-1 px-2 rounded">After</div>
                </div>
              </div>
              <div className="p-4">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8">
            <div className="md:w-1/3">
              <div className="flex items-center gap-2 mb-4">
                <Image src="/images/dumbbell-icon.png" alt="ダンベルアイコン" width={30} height={20} />
